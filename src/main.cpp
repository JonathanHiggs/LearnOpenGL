...
int main()
{
    ...
    //auto phongShader = Shader("assets/shaders/phong-shader.vert", "assets/shaders/phong-shader.frag");
    //auto materialShader = Shader("assets/shaders/material-shader.vert", "assets/shaders/material-shader.frag");
    //auto multiLightShader = Shader("assets/shaders/multi-light-shader.vert", "assets/shaders/multi-light-shader.frag");
    //auto lightShader = Shader("assets/shaders/light-shader.vert", "assets/shaders/light-shader.frag");
    auto backpackShader = Shader("assets/shaders/backpack-shader.vert", "assets/shaders/backpack-shader.frag");

    auto textureManager = TextureManager();
    //auto texture = textureManager.LoadTexture("assets/textures/wall.jpg");
    auto diffuseTexture = textureManager.LoadTexture("assets/textures/container2.png", TextureType::Diffuse);
    auto specularTexture = textureManager.LoadTexture("assets/textures/container2_specular.png", TextureType::Specular);

    auto backpack = Model("assets/models/backpack/backpack.obj", textureManager);
    ...
    while (!window.ShouldClose())
    {
        ...
        backpackShader.SetMat4("projection", window.Projection());
        backpackShader.SetMat4("view", camera.View());
